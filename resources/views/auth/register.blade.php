    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card shadow py-lg-5">
                <div class="text-center mb-lg-4"><b style="font-weight:bolder!important;" class="text-primary"><strong  style="font-weight:bolder!important;">iLanding CREATE ACCOUNT</strong></b></div>
